...
function onCreate()
	...
	makeLuaSprite('sky', 'Glitch', -100, -325);

	makeAnimatedLuaSprite('glitchSky', 'NewTitleMenuBG', -100, -50);
	addAnimationByPrefix('glitchSky', 'lsd', 'TitleMenuSSBG instance 1', 24, true);
	scaleObject('glitchSky', 5, 4);
	setScrollFactor('sky', 0.7, 0.7);
	
	makeLuaSprite('backtrees', 'Trees', -15, -250);
	makeLuaSprite('trees', 'Trees2', -15, -250);
	makeLuaSprite('ground', 'Grass', -15, -130);
	...
	makeAnimatedLuaSprite('p3static', 'Phase3Static', 0, 0);
...
function onEvent(name, value1, value2)
	...
	if name == 'tailsjump' then
		makeLuaSprite('jumpimage', 'Tails', 0, 0);
	...
	if name == 'knuxjump' then
		makeLuaSprite('jumpimage', 'Knuckles', 0, 0);
		setObjectCamera('jumpimage', 'camother');
		addLuaSprite('jumpimage', false);
	...
	if name == 'eggjump' then
		makeLuaSprite('jumpimage', 'Eggman', 0, 0);
		setObjectCamera('jumpimage', 'camother');
		addLuaSprite('jumpimage', false);
