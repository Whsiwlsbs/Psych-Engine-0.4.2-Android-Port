function onCreate()
	makeLuaSprite('sky', 'sky', -15, -130);
	
	makeLuaSprite('backtrees', 'backtrees', -15, -130);
	makeLuaSprite('trees', 'trees', -15, -130);
	makeLuaSprite('ground', 'ground', -15, -130);
...
function onStepHit()
	...
	if curStep == 527 then
		makeLuaSprite('greenhill', 'GreenHill', 1135, 415);
