...
function onCreate()
	...
	makeLuaSprite('sky', 'sky', -650, -850);
	scaleObject('sky', 0.6, 0.6);
	makeLuaSprite('hills', 'hills1', -650, -850);
	scaleObject('hills', 0.8, 0.8);
	makeLuaSprite('ground', 'floor', -750, -400);
	scaleObject('ground', 0.85, 0.55);
	makeLuaSprite('tree', 'tree', -825, -880);
	scaleObject('tree', 0.8, 0.8);

	scaleObject('flower1', 0.6, 0.6);
	makeLuaSprite('flower2', 'smallflowe2', -175, -450);
	scaleObject('flower2', 0.6, 0.6);
	makeLuaSprite('flower3', 'smallflower', -175, -450);
	scaleObject('flower3', -0.6, 0.6);

	makeAnimatedLuaSprite('notknuckles', 'NotKnuckles_Assets', 550, -325);
	addAnimationByPrefix('notknuckles', 'idle', 'Notknuckles', 24, true);
	scaleObject('notknuckles', 0.5, 0.5);

	makeAnimatedLuaSprite('eyeflower', 'WeirdAssFlower_Assets', 125, -200);
