...
function onCreate()
	...
	makeLuaSprite('floor', 'FLOOR1', 25, -100);
	makeLuaSprite('floor2', 'FLOOR2', 0, -135);
	makeLuaSprite('grass', 'frontgrass', 25, -100);
	makeLuaSprite('egg', 'EGGMAN', -10, -100);
	makeLuaSprite('tail', 'TAIL', -110, -100);
	makeLuaSprite('knuckle', 'KNUCKLE', 650, -200);
	makeLuaSprite('hills', 'HILLS', 25, -100);
	makeLuaSprite('sky', 'SKY', 25, -100);
	makeAnimatedLuaSprite('tailsspike', 'TailsSpikeAnimated', 225, 140);
	...
	makeLuaSprite('jumpimage', 'simplejump', -20, 0);-- 85^2
	setObjectCamera('jumpimage', 'camother')
	scaleObject('jumpimage', 0.75, 0.75);

	makeAnimatedLuaSprite('sonicscare', 'sonicJUMPSCARE', 50, 15);
