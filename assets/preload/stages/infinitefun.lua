...
function onCreate()
	...
	makeLuaSprite('sky', 'sonicFUNsky', -50, 0);
	makeLuaSprite('bushback', 'Bush2', -150, 400);
	
	if not lowQuality then
	followchars = true;
	makeAnimatedLuaSprite('backboppers', 'Majin Boppers Back', 300, -125);
	addAnimationByPrefix('backboppers', 'bop', 'MajinBop2 instance 1', 24, false);

	makeLuaSprite('bushfront', 'Bush 1', -75, 573);
	end

	makeAnimatedLuaSprite('frontboppers', 'Majin Boppers Front', 50, -150);
	addAnimationByPrefix('frontboppers', 'bop', 'MajinBop1 instance 1', 24, false);

	makeLuaSprite('ground', 'floor BG', -35, 773);

	if not lowQuality then
	makeAnimatedLuaSprite('fgbopperleft', 'majin FG2', 0, 950);
	addAnimationByPrefix('fgbopperleft', 'bop', 'majin front bopper2', 24, false);

	makeAnimatedLuaSprite('fgbopperright', 'majin FG1', 1400, 950);
